...
function DownloadPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Download Bot</h1>
        <p className="text-muted-foreground mt-1">Get the latest desktop application for your plan.</p>
      </div>
